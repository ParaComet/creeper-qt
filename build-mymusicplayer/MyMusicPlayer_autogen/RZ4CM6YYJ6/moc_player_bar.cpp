...
void PlayerBar::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 4: _t->seek_requested((*reinterpret_cast<std::add_pointer_t<double>>(_a[1]))); break;
        case 5: _t->volume_changed((*reinterpret_cast<std::add_pointer_t<double>>(_a[1]))); break;
        case 6: _t->favorite_toggled((*reinterpret_cast<std::add_pointer_t<bool>>(_a[1]))); break;
        case 7: _t->add_to_playlist_clicked(); break;
        case 8: _t->cover_clicked(); break;
        case 9: _t->on_play_pause_clicked(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        if (QtMocHelpers::indexOfMethod<void (PlayerBar::*)()>(_a, &PlayerBar::previous_clicked, 3))
            return;
        if (QtMocHelpers::indexOfMethod<void (PlayerBar::*)(double )>(_a, &PlayerBar::seek_requested, 4))
            return;
        if (QtMocHelpers::indexOfMethod<void (PlayerBar::*)(double )>(_a, &PlayerBar::volume_changed, 5))
            return;
        if (QtMocHelpers::indexOfMethod<void (PlayerBar::*)(bool )>(_a, &PlayerBar::favorite_toggled, 6))
            return;
        if (QtMocHelpers::indexOfMethod<void (PlayerBar::*)()>(_a, &PlayerBar::add_to_playlist_clicked, 7))
            return;
        if (QtMocHelpers::indexOfMethod<void (PlayerBar::*)()>(_a, &PlayerBar::cover_clicked, 8))
            return;
    }
}
